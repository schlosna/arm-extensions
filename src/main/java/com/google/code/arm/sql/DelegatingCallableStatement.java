...
public abstract class DelegatingCallableStatement<S extends CallableStatement> extends DelegatingPreparedStatement<S> implements CallableStatement {

    protected DelegatingCallableStatement(S delegate) {
        super(delegate);
    }
