...
/**
 * @param <S>
 *            The type of delegate {@link ResultSet}
 */
@SuppressWarnings("deprecation")
public abstract class DelegatingResultSet<S extends ResultSet> extends DelegatingWrapper<S> implements ResultSet {

    protected DelegatingResultSet(S delegate) {
        super(delegate);
    }
